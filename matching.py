#It is easy to understand this code by using interactive mode of Python
import numpy as np
...
def match(clustering1, clustering2, weights=None, threshold=.2, noise_index=0):
    ...
    #print(f"cluster_ids2 : {cluster_ids2}")
    ...
    # Make numpy array of all pairs : [[0,1,2,･･･,n_cluster1],···]-->Number of array is n_cluster2
